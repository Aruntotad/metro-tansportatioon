...
<div style="background-image:url(h2.png);background-repeat: no-repeat;height: 200px;background-size: center;"> <br><br>
    ...
    <h2 style="color:black; background-color:orange;"><Center> Delete Train Detail </Center></h2>
     <center>
  <?php 
...
<option value="Train_name">Train name</option>
        ...
        <br><br>
        <label> <strong>Delete train : </strong><strong><input type="text" name="criteria" required /></strong></label>
        <br><br>
...
if(true)
$query= "delete from trains where ".$category."='$criteria'";
